...
class TraversableSpecTest extends FlatSpec with ShouldMatchers with MockitoSugar {
  ...
  "fibonacci" should "use infinite core.collection stream" in {
  ...
  "flatmap" should "handle core.collection of collections" in {
